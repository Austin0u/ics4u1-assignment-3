...
export const CubicInput = ({ a, b, c, d, setA, setB, setC, setD }: CubicProps) => {
    const handleSubmit = (event: React.FormEvent) => {
        ...
        // }
        console.log(a, b, c, d); // should do a rerender with state
        // PUT CODE TO SAVE TO HISTORY HERE (how send to other component??? array?)
    };
